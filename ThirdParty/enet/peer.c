...
enet_peer_send (ENetPeer * peer, enet_uint8 channelID, ENetPacket * packet)
{
   ...
   size_t headerSize = (peer -> host -> useNewPacket == 1) ? sizeof (ENetGTProtocolHeader) : sizeof (ENetProtocolHeader);
   fragmentLength = peer -> mtu - headerSize - sizeof (ENetProtocolSendFragment);
